...
async function main() {
    ...
    try {
        ...
        const projectNameVer = createProjectName(packageJson, true);
        ...
        const zipFileInProjectDir = path.join(projectDir, `${projectNameVer}.zip`);
 ...
 * @param {boolean} includeVersion - Whether or not to append version number.
 * @returns {string} A string representing the constructed project name.
 */
function createProjectName(packageJson, includeVersion) {
