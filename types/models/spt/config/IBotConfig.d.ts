...
export interface IBotConfig extends IBaseConfig {
    accountTypeWeight: { "1": number; "2": number; "256": number; /** Should the stock mod be forced to spawn on bot */ /** Should the stock mod be forced to spawn on bot */ "512": number; };
    gameVersionWeight: { edge_of_darkness: number; };
    kind: "aki-bot";
